...
export const DebtorsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        calculateFines: async (referenceDates: any, userTypes?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DebtorsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async calculateFines(referenceDates: any, userTypes?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserToFineResponse>>> {
...
export class DebtorsApi extends BaseAPI {
     ...
     * @memberof DebtorsApi
     */
    public calculateFines(referenceDates: any, userTypes?: any, options?: AxiosRequestConfig) {
