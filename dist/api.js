...
const AuthenticateApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        secureMemberPINAuthentication: async (memberAuthenticationSecurePinRequest, options = {}) => {
            // verify required parameter 'memberAuthenticationSecurePinRequest' is not null or undefined
...
const AuthenticateApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = base_1.operationServerMap['AuthenticateApi.secureMemberPINAuthentication']?.[index]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         *
...
const AuthenticateApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        memberPinAuthentication(memberAuthenticationPinRequest, options) {
            return localVarFp.memberPinAuthentication(memberAuthenticationPinRequest, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Mock login and hand out token.
         ...
         * @throws {RequiredError}
         */
        secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options) {
            return localVarFp.secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Secure NFC authentication that requires POS user authentication
...
class AuthenticateApi extends base_1.BaseAPI {
     ...
     */
    memberPinAuthentication(memberAuthenticationPinRequest, options) {
        return (0, exports.AuthenticateApiFp)(this.configuration).memberPinAuthentication(memberAuthenticationPinRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Mock login and hand out token.
     ...
     */
    secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options) {
        return (0, exports.AuthenticateApiFp)(this.configuration).secureMemberPINAuthentication(memberAuthenticationSecurePinRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Secure NFC authentication that requires POS user authentication
...
class PayoutRequestsApi extends base_1.BaseAPI {
     ...
     */
    getPayoutRequestPdf(id, force, options) {
        return (0, exports.PayoutRequestsApiFp)(this.configuration).getPayoutRequestPdf(id, force, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a single payout request
...
class TransactionsApi extends base_1.BaseAPI {
     ...
     */
    getAllTransactions(fromId, createdById, toId, excludeById, excludeFromId, pointOfSaleId, productId, productRevision, fromDate, tillDate, take, skip, options) {
        return (0, exports.TransactionsApiFp)(this.configuration).getAllTransactions(fromId, createdById, toId, excludeById, excludeFromId, pointOfSaleId, productId, productRevision, fromDate, tillDate, take, skip, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a single transaction
     ...
     */
    getTransactionPdf(id, options) {
        return (0, exports.TransactionsApiFp)(this.configuration).getTransactionPdf(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Updates the requested transaction
...
const TransfersApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllTransfers(fromDate, tillDate, take, skip, options) {
...
class TransfersApi extends base_1.BaseAPI {
     ...
     */
    getAllTransfers(fromDate, tillDate, take, skip, options) {
        return (0, exports.TransfersApiFp)(this.configuration).getAllTransfers(fromDate, tillDate, take, skip, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Returns the requested transfer
     ...
     */
    getTransferPdf(id, options) {
        return (0, exports.TransfersApiFp)(this.configuration).getTransferPdf(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const UserNotificationPreferencesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllUserNotificationPreferences(userNotificationPreferenceId, userId, type, channel, enabled, options) {
         ...
         * @throws {RequiredError}
         */
        getSingleUserNotificationPreference(id, options) {
         ...
         * @throws {RequiredError}
         */
        updateUserNotificationPreference(id, userNotificationPreferenceUpdateRequest, options) {
...
class UserNotificationPreferencesApi extends base_1.BaseAPI {
     ...
     */
    getAllUserNotificationPreferences(userNotificationPreferenceId, userId, type, channel, enabled, options) {
        return (0, exports.UserNotificationPreferencesApiFp)(this.configuration).getAllUserNotificationPreferences(userNotificationPreferenceId, userId, type, channel, enabled, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Return a single user notification preferences in the system.
     ...
     */
    getSingleUserNotificationPreference(id, options) {
        return (0, exports.UserNotificationPreferencesApiFp)(this.configuration).getSingleUserNotificationPreference(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update a user notification preferences in the system.
     ...
     */
    updateUserNotificationPreference(id, userNotificationPreferenceUpdateRequest, options) {
        return (0, exports.UserNotificationPreferencesApiFp)(this.configuration).updateUserNotificationPreference(id, userNotificationPreferenceUpdateRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
class WriteoffsApi extends base_1.BaseAPI {
     ...
     */
    getWriteOffPdf(id, force, options) {
        return (0, exports.WriteoffsApiFp)(this.configuration).getWriteOffPdf(id, force, options).then((request) => request(this.axios, this.basePath));
    }
}
